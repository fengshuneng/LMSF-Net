...
def get_params():
    params = {
        'weight': '/home/robot/ultralytics-yolo11-main/runs/prune/YOLO11-RASS-lamp-exp1-finetune/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'/home/robot/ultralytics-yolo11-main/new_VOC1/test/images', 'result4')
