...
__all__ = ['AIFI_RepBN', 'C2BRA', 'C2CGA', 'C2DA', 'C2DPB', 'C2Pola', 'C2TSSA', 'C2ASSA', 'C2PSA_DYT', 'C2TSSA_DYT', 'C2Pola_DYT',
           'C2PSA_FMFFN', 'C2PSA_CGLU', 'C2PSA_SEFN', 'C2PSA_Mona', 'C2TSSA_DYT_Mona', 'C2TSSA_DYT_Mona_SEFN']
...
class C2PSA_SEFN(C2PSA):
    def __init__(self, c1, c2, n=1, e=0.5):
        ...
        nn.Sequential(*(PSABlock_SEFN(self.c, attn_ratio=0.5, num_heads=self.c // 64) for _ in range(n)))
...
class C2TSSA_DYT_Mona_SEFN(C2PSA):
    def __init__(self, c1, c2, n=1, e=0.5):
        ...
        nn.Sequential(*(TSSAlock_DYT_Mona_SEFN(self.c, attn_ratio=0.5, num_heads=self.c // 64) for _ in range(n)))
