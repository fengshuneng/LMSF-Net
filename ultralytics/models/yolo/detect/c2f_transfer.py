...
# 没有购买yolov11项目需要注释以下
from ultralytics.nn.extra_modules.block import RepNCSPELAN4, C3k2_Faster_CGLU, C3k_Faster_CGLU, C3k2_MutilScaleEdgeInformationEnhance, C3k_MutilScaleEdgeInformationEnhance, C3k2_EMSCP, C3k2_MutilScaleEdgeInformationSelect
...
def replace_c2f_v2_with_c2f(module):
    ...
    # for name, child_module in module.named_children():
    #     if isinstance(child_module, C3k2_Faster_CGLU_v2):
    #         # Replace C2f with C2f_v2 while preserving its parameters
    #         shortcut = infer_shortcut(child_module.m[0])
    #         c3k = child_module.m[0] is C3k_Faster_CGLU
    #         if c3k:
    #             g = 1
    #         else:
    #             g = 1
    #         c2f_v2 = C3k2_Faster_CGLU_infer(child_module.cv1.conv.in_channels, child_module.cv2.conv.out_channels,
    #                         n=len(child_module.m), shortcut=shortcut,
    #                         g=g,
    #                         c3k=c3k,
    #                         e=child_module.c / child_module.cv2.conv.out_channels)
...
def replace_c2f_with_c2f_v2(module):
    ...
    # for yolo11-C3k2-Faster-CGLU-RSCD.yaml
    # for name, child_module in module.named_children():
    #     if isinstance(child_module, C3k2_Faster_CGLU):
    #         # Replace C2f with C2f_v2 while preserving its parameters
    #         shortcut = infer_shortcut(child_module.m[0])
    #         c3k = child_module.m[0] is C3k_Faster_CGLU
    #         if c3k:
    ...
    #         else:
    #             g = 1
    #         c2f_v2 = C3k2_Faster_CGLU_v2(child_module.cv1.conv.in_channels, child_module.cv2.conv.out_channels,
    #                         n=len(child_module.m), shortcut=shortcut,
    #                         g=g,
    #                         c3k=c3k,
    #                         e=child_module.c / child_module.cv2.conv.out_channels)
    ...
    # for name, child_module in module.named_children():
    #     if isinstance(child_module, C3k2_MutilScaleEdgeInformationSelect):
    #         # Replace C2f with C2f_v2 while preserving its parameters
    #         shortcut = infer_shortcut(child_module.m[0])
    #         c3k = child_module.m[0] is C3k_MutilScaleEdgeInformationSelect
    #         if c3k:
    #             g = 1
    #         else:
    #             g = 1
    #         c2f_v2 = C3k2_MutilScaleEdgeInformationSelect_v2(child_module.cv1.conv.in_channels, child_module.cv2.conv.out_channels,
    #                         n=len(child_module.m), shortcut=shortcut,
    #                         g=g,
    #                         c3k=c3k,
    #                         e=child_module.c / child_module.cv2.conv.out_channels)
    #         transfer_weights_c2f_to_c2f_v2(child_module, c2f_v2)
    #         setattr(module, name, c2f_v2)
    #     elif isinstance(child_module, C3k2):
    #         # Replace C2f with C2f_v2 while preserving its parameters
    #         shortcut = infer_shortcut(child_module.m[0])
    #         c3k = child_module.m[0] is C3k
    #         if c3k:
    ...
    # for yolo11-C3k2-MutilScaleEdgeInformationEnhance.yaml
    # for name, child_module in module.named_children():
    #     if isinstance(child_module, C3k2_EMSCP):
    #         # Replace C2f with C2f_v2 while preserving its parameters
    #         shortcut = infer_shortcut(child_module.m[0])
    #         c3k = child_module.m[0] is C3k_EMSCP
    #         if c3k:
    #             g = 1
    #         else:
    #             g = 1
    #         c2f_v2 = C3k2_EMSCP_v2(child_module.cv1.conv.in_channels, child_module.cv2.conv.out_channels,
    #                         n=len(child_module.m), shortcut=shortcut,
    #                         g=g,
    #                         c3k=c3k,
    #                         e=child_module.c / child_module.cv2.conv.out_channels)
