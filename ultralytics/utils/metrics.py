...
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=True, EIoU=False, SIoU=False, ShapeIoU=False, PIoU=False, PIoU2=False, eps=1e-7, scale=0.0, Lambda=1.3):
    """
