...
if __name__ == '__main__':
    model = YOLO('/home/robot/YOLOv8/runs/train1/rtdetr-l/weights/best.pt') # select your model.pt path
    model.predict(source='/home/robot/ultralytics-yolo11-main/new_VOC1/test/images',
                  imgsz=640,
                  project='runs/detect',
                  name='exp',
                  save=True,
