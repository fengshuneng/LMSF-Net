...
```
python plot_channel_image.py --base-weights runs/prune/YOLO11-RACS-lamp-exp1-prune11/weights/model_c2f_v2.pt --prune-weights runs/prune/YOLO11-RASS-lamp-exp1-finetune/weights/best.pt
...
param_dict = {
        # origin
        'model': '/home/robot/ultralytics-yolo11-main/runs/train1/YOLO11-RACS/weights/best.pt',
